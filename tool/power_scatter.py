...
if __name__ == '__main__':
  ...
  plt.scatter(natural_power, world_power, c="k", s=3.0, label="Original")
  plt.scatter(natural_power, modified_power, c="r", s=3.0, label="WORLD")
  plt.xlim(-70,-10)
  plt.ylim(-70,-10)
  plt.show()
  
  world_corr = np.corrcoef(natural_power, world_power)
  modified_corr = np.corrcoef(natural_power, modified_power)
  print(world_corr, modified_corr)
